...
import { fetchSeriesCategories, fetchSeriesItems } from '../services/provider';
...
function TopNav({ navigation }) {
  const tabs = [
    ...
    { id: 'series', label: 'Series',  icon: 'film-outline',        onPress: () => {} },
  ];
  return (
...
function SeriesCard({ item, cardWidth, onPress }) {
